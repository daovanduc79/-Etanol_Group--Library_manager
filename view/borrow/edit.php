...
<div class="container">
    <div class="row">
        <form role="form" class="col-md-9 go-right" method="post">
            ...
            <div class="form-group">
                <input id="borrow_date" name="borrow_date" type="date" class="form-control" required>
                <label for="borrow_date">Borrow Date</label>
            </div>
            <div class="form-group">
                <input id="return_date" name="return_date" type="date" class="form-control" required>
